...
const { getAllChildren, getChildSingleChild, getChildrenFromGroup, getAttendanceOfChild } = require("../controllers/childControllers/getControllers")
...
router.get("/getAttendanceOfChild/:id", getAttendanceOfChild)   // child id
